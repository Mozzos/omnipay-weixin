...
class ExpressCompletePurchaseRequest extends BasePurchaseRequest
{
    ...
    /**
     * @deprecated use getWeixinPublicKey instead
     * @return mixed
     */
    ...
    /**
     * @deprecated use setWeixinPublicKey instead
     *
     * @param $value
     *
     * @return $this
    ...
    public function setWeixinPublicKey($value)
    {
        return $this->setParameter('alipay_public_key', $value);
    }
    ...
    public function getWeixinPublicKey()
    {
        return $this->getParameter('alipay_public_key');
    }
    ...
    protected function isSignMatch()
    {
        ...
        if ($signType == 'MD5') {
            ...
            $publicKey = $this->getWeixinPublicKey();
